(function (factory) {
  ...
  * ============================== */
  ...
  var Tokenfield = function (element, options) {
    ...
    // changed by tba (filter method on _delimiters): don't use the whitespace delimiter as triggerkey
    this._triggerKeys = $.map(this._delimiters.filter(function(element){return element != " ";}), function (delimiter) {
    ...
    var elStyleWidth = element.style.width, elWidth = this.$element.width()
    ...
    // AHA 23.08.17 - Removed this strange looking line as it crashes Safari on IOS!
  ...
  , keypress: function(e) {
      ...
      if ($.inArray( e.which, this._triggerKeys) !== -1 && this.$input.is(document.activeElement)) {
          var val = this.$input.val(), quoting = /^"[^"]*$/.test(val);
          if (quoting) return;
