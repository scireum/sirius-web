...
(function (a, b) {
    ...
    d.each(["live", "die"], function (a, c) {
        ...
        var i = function (b, d, e, g) {
            ...
            if (x.length > 1 && k.exec(b))if (x.length === 2 && j.relative[x[0]])m = t(x[0] + x[1], d); else {
            ...
            o || (o = m), o || i.error(r || b);
            if (f.call(o) === "[object Array]")if (v)if (d && d.nodeType === 1)for (u = 0; o[u] != null; u++)o[u] && (o[u] === !0 || o[u].nodeType === 1 && i.contains(d, o[u])) && e.push(m[u]); else for (u = 0; o[u] != null; u++)o[u] && o[u].nodeType === 1 && e.push(m[u]); else e.push.apply(e, o); else n(o, e);
        ...
        i.uniqueSort = function (a) {
            ...
            while (a && c.length) {
                ...
                if (a === h)if (g == null)i.error(a); else break;
                h = a
            }
            return l
        }, i.error = function (a) {
    ...
    d.fn.extend({load: function (a, b, c) {
        ...
        i.promise(v), v.success = v.done, v.error = v.fail, v.complete = j.done, v.statusCode = function (a) {
            if (a) {
                var b;
                if (t < 2)for (b in a)k[b] = [k[b], a[b]]; else b = a[v.status], v.then(b, b)
            }
            return this
        ...
        if (!f.beforeSend || f.beforeSend.call(g, v, f) !== !1 && t !== 2) {
            for (u in {success: 1, error: 1, complete: 1})v[u](f[u]);
            o = bG(bE, f, e, v);
            if (o) {
    ...
    d.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        if (b.dataTypes[0] === "jsonp" || c.jsonpCallback || c.jsonp != null || b.jsonp !== !1 && (bL.test(b.url) || e && bL.test(b.data))) {
            ...
            b.jsonp !== !1 && (i = i.replace(bL, k), b.url === i && (e && (j = j.replace(bL, k)), b.data === j && (i += (/\?/.test(i) ? "&" : "?") + b.jsonp + "=" + g))), b.url = i, b.data = j, a[g] = function (a) {
                ...
                a[g] = h;
                if (h)f && d.isFunction(h) && a[g](f[0]); else try {
                    delete a[g]
                } catch (b) {
                }
    ...
    var bR = {}, bS = /^(?:toggle|show|hide)$/, bT = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, bU, bV = [
    ...
    d.fn.extend({show: function (a, b, c) {
        ...
        return this[f.queue === !1 ? "each" : "queue"](function () {
            ...
            b.overflow != null && (this.style.overflow = "hidden"), b.curAnim = d.extend({}, a), d.each(a, function (c, e) {
                ...
                if (bS.test(e))f[e === "toggle" ? g ? "show" : "hide" : e](a); else {
