...
import sirius.web.templates.velocity.ImageReplacedElementFactory;
 ...
 */
@Register(name = TagliatellePDFContentHandler.PDF_VM)
public class TagliatellePDFContentHandler implements ContentHandler {
