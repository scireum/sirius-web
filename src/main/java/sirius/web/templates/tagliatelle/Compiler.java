...
import sirius.web.templates.tagliatelle.emitter.ConditionalEmitter;
import sirius.web.templates.tagliatelle.emitter.ConstantEmitter;
import sirius.web.templates.tagliatelle.emitter.Emitter;
import sirius.web.templates.tagliatelle.emitter.ExpressionEmitter;
...
public class Compiler extends InputProcessor {
    ...
    public Compiler(String name, Resource resource, String input, CompilationContext context) {
    ...
    public Template compile() throws CompileException {
        ...
        result = new Template(name, resource);
    ...
    private void handleTag(TagHandler parentHandler, TagHandler handler, String tagName, CompositeEmitter block) {
        ...
        handler.apply(new TagContext(startOfTag, context, result, parentHandler, block));
    }
