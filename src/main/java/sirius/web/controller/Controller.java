...
/**
 * A <code>Controller</code> is responsible for handling incoming HTTP requests.
 * <p>
 ...
 * </pre>
 * <p>
 * URIs can have numbered parameters like <code>/tests/:1/foos/:2</code>. This method needs to have two string
 * parameters (e.g. <code>void foo(WebContext ctx, String testId, String fooId)</code>).
