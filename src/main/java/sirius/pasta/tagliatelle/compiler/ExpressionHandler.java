...
public abstract class ExpressionHandler implements Priorized {
     ...
     *
     * @param compiler the compiler which provides access to the {@link TemplateCompiler#getReader()} and {@link
     *                 TemplateCompiler#getContext()}.
     ...
     */
    public abstract boolean shouldProcess(TemplateCompiler compiler);
     ...
     */
    @Nullable
    public abstract Emitter process(TemplateCompiler compiler);
}
