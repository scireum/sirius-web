...
public class DynamicInvokeTemplateEmitter extends Emitter {
    ...
    protected void emitToContext(LocalRenderContext context) throws Exception {
        ...
        try {
            ...
            emitDebugMessage(context, "start rendering dynamic template '" + effectiveTemplateName + "'");
            template.renderWithContext(subContext);
            emitDebugMessage(context, "finish rendering dynamic template '" + effectiveTemplateName + "'");
        } finally {
            subContext.release();
        }
    }
