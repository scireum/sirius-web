...
class SamlTest {
    ...
    fun `ADFS SAML response fails correctly when considering time`() {
        ...
        assertEquals(
            "Ein Fehler ist aufgetreten: Invalid SAML Response: Invalid IssueInstant: 2022-05-12T11:17:00.648Z",
            exception.message
        )
    }
...
""", false
        ...
        assertEquals(
            "Ein Fehler ist aufgetreten: An error occurred while parsing a SAML Response: It is forbidden to use algorithm http://www.w3.org/2000/09/xmldsig#rsa-sha1 when secure validation is enabled (javax.xml.crypto.MarshalException)",
            exception.message
        )
