...
class InlineSvgMacroTest extends BaseSpecification {
    ...
    private static Tagliatelle tagliatelle
        ...
        ctx
                .getTemplate()
                .renderToString() == "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"#000000\" height=\"32\" version=\"1.1\" viewBox=\"0 0 32 32\" width=\"32\">\n" +
